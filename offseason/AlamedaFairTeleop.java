...
public class Meet4Teleop extends OpMode {
    ...
    private static final Pose RESET_POSE =
            new Pose(16.70687598615511, 120.47742254104709, Math.toRadians(144));
    ...
    static {
        ...
        addPoint(17.7, 1015, 0.08);
        addPoint(23.77, 1020, 0.1);
        addPoint(28.68, 1080, 0.25);
        addPoint(36.2, 1180, 0.33);
        addPoint(41.60, 1275, 0.35);
        addPoint(47.75, 1340, 0.35);
        addPoint(56.26, 1380, 0.36);
        addPoint(65.67, 1410, 0.40);
        addPoint(70.28, 1495, 0.40);
        addPoint(75.5, 1555, 0.40);
        addPoint(80.25, 1610, 0.43);
        addPoint(85.6, 1610, 0.46);
        addPoint(93.27, 1610, 0.46);
        addPoint(98.43, 1680, 0.46);
        addPoint(103.38, 1715, 0.44);
        addPoint(108.3, 1780, 0.46);
    ...
    public void init() {
        ...
        telemetry.addData("Start Pose", "X: %.2f, Y: %.2f, H: %.1f°",
        ...
        telemetry.addData("Normal Offset", "%.1f° (Left)", Math.toDegrees(HEADING_OFFSET_DEFAULT));
        telemetry.addData("Far Shot Offset", "%.1f° (Right)", Math.toDegrees(HEADING_OFFSET_FAR_SHOT));
        telemetry.addData("Y Threshold", "%.2f", Y_THRESHOLD);
        telemetry.addData("", "");
        telemetry.addData("A Button", "Toggle Auto-Lock to Goal");
        telemetry.addData("B Button", "Reset Pose to (17.52, 120.07, 144°)");
        telemetry.update();
    }
    ...
    public void loop() {
        ...
        telemetry.addData("", "");
        telemetry.addData("Robot Pose", "X: %.2f, Y: %.2f, H: %.1f°",
        ...
        if (headingLock) {
            ...
            telemetry.addData("Current Offset", "%.1f°", Math.toDegrees(currentOffset));
    ...
    private double calculateHeadingToGoalWithOffset() {
        ...
        // If Y < threshold (robot is in far shot zone), offset right (1.7°)
        // Otherwise, use default left offset (5°)
        double offset;
