...
@Autonomous(name = "BroganAutoFinalRed", group = "Autonomous")
public class BroganAutoFinalRed extends OpMode {
    ...
    // POSITION DECLARING
    private final Pose startPose = new Pose(121.780,126,Math.toRadians(35));
    private final Pose shootPose = new Pose(89.09198813056379,88.45103857566765, Math.toRadians(46));

    private final Pose endPose = new Pose(64,105,Math.toRadians(90)); //TESTING POSE

    private final Pose pickUpLineUp = new Pose(88.63798219584571,85.073293768546, Math.toRadians(0));
    private final Pose pickUp = new Pose(133.55816023738872,87.073293768546,Math.toRadians(0));
